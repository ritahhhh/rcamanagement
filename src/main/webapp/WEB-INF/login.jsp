...
<html>
<head>
    <title>Login | RCA Management..</title>
...
<div class="w-1/2 flex min-h-screen"
     style="background-size: cover;background: url('https://static.vecteezy.com/system/resources/previews/005/879/539/original/cloud-computing-modern-flat-concept-for-web-banner-design-man-enters-password-and-login-to-access-cloud-storage-for-uploading-and-processing-files-illustration-with-isolated-people-scene-free-vector.jpg') no-repeat center;">
</div>
<div class="w-1/2 flex flex-col justify-center items-center min-h-screen">
    ...
    <div class="flex items-center my-2 justify-center">
        ...
        <a href="register?page=createuser" style="text-underline: none" class="text-blue-700">Get
            Started</a>
    </div>
    <form action="login" method="post" class="w-3/5 flex flex-col">
